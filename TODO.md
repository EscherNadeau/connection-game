...
- [ ] **Reveal-first win screen:** the pull is the headline ("The pull: **Ramis was in Airheads** 🤯"), the route second, stars/counts demoted to fine print. Stars keep all their plumbing jobs (medal tiers, share text, par) — they just lose the marquee. Mind the win-modal shell-restore contract (eyebrow/h1/`#win-stars` — knowledge/hybrid/finale paths).
...
- [ ] **Flares get BIG** — merges with the Tier-0 party pass (a flare readable across a room and a flare that feels like 🎬 BOOM are the same requirement). Highest fun-per-effort item on the board.
